...
import ChatWindow from "./chatwindowG.vue";  // 导入聊天窗口组件

import { getGroup } from "@/api/getData";  // 导入获取好友数据的 API 调用
export default {
  name: "App",
  components: {
  ...
  methods: {
    ...
    clickPerson(info) {
      ...
      console.log("FlagIndexG changed to false:", this.FlagIndex); // 检查FlagIndex的更新
